Class('App.QKZX.DeliveryStock', 'xui.Module',{
	autoDestroy : true,
	Instance:{
		initialize : function(){
			var ns=this;
		...
		_ctl_sbutton14_onclick:function(){
			...
			_.arr.each(rows,function(row){
				var data={};
				_.arr.each(['JID','Year','No','RealCounts'], function(i){
			...
			AJAX.callService('QKZX/request',null,"delivery_stock",paras,function (rsp) {
